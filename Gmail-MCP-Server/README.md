...
1. Create a Google Cloud Project and obtain credentials:
   ...
   b. Create OAuth 2.0 Credentials:
      ...
      - For Web application, add `https://luciuslab.xyz:3003/oauth2callback` to the authorized redirect URIs
...
2. Run Authentication:
   ...
   > - For Web application credentials, make sure to add `https://luciuslab.xyz:3003/oauth2callback` to your authorized redirect URIs
...
3. **Port Already in Use**
   - If port 3003 is already in use, please free it up before running authentication
