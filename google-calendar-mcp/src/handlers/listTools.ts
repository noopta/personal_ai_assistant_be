    ...
    tools: [
      ...
      },
      {
        ...
        inputSchema: {
          ...
          properties: {
            ...
            userHashID: {
              type: "string",
              description: "User hash ID associated with the users refresh tokens saved in the server. Given by the LLM in the last sentence.",
            },
          },
          required: ["calendarId"],
        },
      ...
      },
      {
        ...
        inputSchema: {
          ...
          required: ["calendarId", "eventId"], // timeZone is technically required for PATCH but has default
        },
      },
      {
        name: "delete-event",
