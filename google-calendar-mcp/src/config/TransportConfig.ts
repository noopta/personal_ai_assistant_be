...
Options:
  ...
  --port <number>          Port for HTTP transport (default: 3003)
...
Examples:
  ...
  node build/index.js --transport http --port 3003 # HTTP server
  PORT=3003 TRANSPORT=http node build/index.js     # Using env vars
        `);
        process.exit(0);
    }
  }
